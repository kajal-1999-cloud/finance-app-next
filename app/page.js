        ...
        <section className="py-20 bg-blue-600">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Ready to controll of Your Finanaces ?
            </h2>
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join thousand of users who are already managing their free finance </p>
            <Link href="/dashboard">
