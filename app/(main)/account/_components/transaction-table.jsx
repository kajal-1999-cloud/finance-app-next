...
const TransactionsTable = ({ transactions }) => {
  ...
  const filterAndSortedTransactions = useMemo(() => {
    ...
    if (recurringFilter) {
      result = result.filter((transaction) => {
        if (recurringFilter === "recurring") return transaction.isReccuring;
        ...
        <Table>
          <TableHeader>
            <TableRow>
                ...
                <div className="flex items-center">
                  ...
                  {sortConfig.field === "date" &&
                    (sortConfig.direction === "asc" ? (
                      <ChevronUp className="ml-1 h4 w-4" />
                    ) : (
                      <ChevronDown className="ml-1 h4 w-4" />
                    ))}
                </div>
              </TableHead>
              ...
              >
                {" "}
                <div className="flex items-end"> Recurring</div>
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
